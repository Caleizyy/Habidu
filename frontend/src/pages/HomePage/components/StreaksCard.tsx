          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-neutral-200 dark:border-neutral-700">
                <th className="py-2 text-left text-base text-neutral-900 dark:text-neutral-100">Type</th>
              ...
              {streaks.map((streak, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-center">
                    <span className="inline-block rounded-lg bg-orange-50 px-3 py-1 text-lg font-bold text-orange-600 dark:bg-orange-950/30 dark:text-orange-400">
                      {streak.current}
                    </span>
                  </td>
                  <td className="px-4 py-3 text-center">
                    <span className="inline-block rounded-lg bg-amber-50 px-3 py-1 text-lg font-bold text-amber-600 dark:bg-amber-950/30 dark:text-amber-400">
                      {streak.best}
                    </span>
                  </td>
                </tr>
