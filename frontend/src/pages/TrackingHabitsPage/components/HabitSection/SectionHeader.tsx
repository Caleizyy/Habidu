...
const SectionHeader = ({
  ...
  return (
    <div
      onClick={onToggle}
      className="flex w-full cursor-pointer items-center gap-3 border-b border-neutral-200 bg-white px-4 py-3 transition-colors hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:bg-neutral-800/80"
    >
